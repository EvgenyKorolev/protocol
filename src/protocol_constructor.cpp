...
QString protocol_constructor::use_adapt(const std::tuple<std::string, std::string, std::string, std::string , std::string>& arg)
{
    ...
    if (std::get<0>(arg) == "_parent_var"){
        std::string tmps = std::get<3>(arg);
        if (tmps.substr(0, 7) == "_obj_app" || tmps.substr(0, 7) == "_ktp_app" || tmps.substr(0, 7) == "_cp_app"){

        app_view->model()->

//            _obj_app - таблица приборов (можно указать стиль таблицы в формате CSS в параметре style) объекта
//            _obj_app1 - таблица приборов (можно указать стиль таблицы в формате CSS в параметре style) объекта, другой формат времени
//            _obj_app2 - таблица приборов (можно указать стиль таблицы в формате CSS в параметре style) объекта, другой формат времени
//            _obj_app3 - таблица приборов (можно указать стиль таблицы в формате CSS в параметре style) объекта, другой формат времени
//            _obj_app4 - таблица приборов (можно указать стиль таблицы в формате CSS в параметре style) объекта, другой формат времени
//            _ktp_app - таблица приборов (можно указать стиль в формате CSS в параметре style) КТП
//            _ktp_app1 - таблица приборов (можно указать стиль в формате CSS в параметре style) КТП, другой формат времени
//            _ktp_app2 - таблица приборов (можно указать стиль в формате CSS в параметре style) КТП, другой формат времени
//            _ktp_app3 - таблица приборов (можно указать стиль в формате CSS в параметре style) КТП, другой формат времени
//            _ktp_app4 - таблица приборов (можно указать стиль в формате CSS в параметре style) КТП, другой формат времени
//            _cp_app - таблица приборов (можно указать стиль в формате CSS в параметре style) ЦП
//            _cp_app1 - таблица приборов (можно указать стиль в формате CSS в параметре style) ЦП, другой формат времени
//            _cp_app2 - таблица приборов (можно указать стиль в формате CSS в параметре style) ЦП, другой формат времени
//            _cp_app3 - таблица приборов (можно указать стиль в формате CSS в параметре style) ЦП, другой формат времени
//            _cp_app4 - таблица приборов (можно указать стиль в формате CSS в параметре style) ЦП, другой формат времени
